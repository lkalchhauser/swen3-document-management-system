...
public class GeminiAiService : IGenAiService
{
	...
	public async Task<string> GenerateSummaryAsync(string text, int maxLength = 200, CancellationToken ct = default)
	{
		...
		var prompt = $"�Provide a concise summary of the following document text in approximately {maxLength} characters or less. Focus on the main points and key information:\n\n{text}";
